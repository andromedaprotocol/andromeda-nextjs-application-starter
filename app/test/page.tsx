...
const Page = (_props: Props) => {
  ...
  const { data: components } =
    trpcReactClient.appContract.getComponents.useQuery({
      "contract-address":
        "archway1j5e0p0hdsv6x6kqkza683kdhsfazlxsr3n58v3pzylgk7w45tjuq9znpcw",
      "chain-identifier": "archway-testnet",
    });
  const { data: addresses } =
    trpcReactClient.appContract.getAddressesWithNames.useQuery({
      "contract-address":
        "andr1xguyrfnys0z0uzwmmkcsj0crqvug4x5x3heekxrzxjjfvzju54rq5fxkmf",
      "chain-identifier": process.env.NEXT_PUBLIC_CHAIN_IDENTIFIER || "",
    });
  return (
    <div>
